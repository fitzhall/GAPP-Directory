...
export const metadata: Metadata = {
  ...
  description: 'The Georgia Pediatric Program (GAPP) provides in-home nursing for medically fragile children. Eligibility, covered services, and how to find providers.',

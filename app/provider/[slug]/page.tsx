...
export default async function ProviderPage({
  ...
  return (
    <>
      ...
      {/* Verified/featured providers get the editorial layout */}
      {provider.isVerified ? (
        <VerifiedProviderProfile provider={provider} />
      ) : (
        /* Unclaimed and claimed-but-unverified get the original layout */
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center max-w-md mx-auto">
                      {contactPhone && (
                        <a
                          ...
                          className="flex items-center justify-center gap-3 px-6 py-3 bg-primary text-white font-medium rounded-lg hover:bg-primary-dark transition-colors"
                        >
